...
@section('title') User - ダッシュボード@endsection
                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Comments<br>(コメントの合計)</span>
                            </div>
                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Commented posts<br>(記事に対してコメントした人数)</span>
                            </div>
