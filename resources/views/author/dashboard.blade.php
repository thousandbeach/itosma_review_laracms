                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Posts today<br>(本日の記事投稿数)</span>
                            </div>
                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Posts all time<br>(全期間の記事投稿数)</span>
                            </div>
                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Comments today<br>(本日のコメント数)</span>
                            </div>
                    ...
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="font-weight-light">Comments all time<br>(全期間のコメント数)</span>
                            </div>
