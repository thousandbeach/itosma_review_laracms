            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <span class="h4 d-block font-weight-normal mb-2">{{ $todayMessages }}</span>
                                <span class="font-weight-light">The number of inquiries &nbsp;&nbsp;(本日のお問合わせ件数)</span>
                            </div>
                ...
                <div class="col-md-8">
                    <div class="card p-4">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <span class="h4 d-block font-weight-normal mb-2">{{ $allMessages->count() }}</span>
                                <span class="font-weight-light">The number of inquiries<br> &nbsp;&nbsp;(すべてのお問合わせ件数)</span>
                            </div>
                            <div class="h2 text-muted">
                                <a href="{{ route('adminContacts') }}" class="btn btn-primary btn-sm">お問合わせ内容を確認する</a>
                            </div>
                            <div class="h2 text-muted">
                                <i class="icon icon-envelope"></i>
                            </div>
